...
print("Balance of my owner address in " + symbol() + " TOKEN is: " + str(balanceOf(ownerAddress)))

# Check Decimals function works
print("Decimal of my owner address in " + symbol() + " TOKEN is: " + str(decimals()))
...
if res:
    ...
    contract_instance = web3.eth.contract(address=contractAddress, abi=abi)
    decimals = 10 ** 18
    targetAccount = web3.toChecksumAddress('0xac35866956C9eD35880Be6c7B229d8E84B7B7280')
